            ...
            @foreach($courses as $course)
                ...
                <!-- program item -->
                    <div class="col-12 col-md-6 col-lg-4">
                        <a href="/courses/{{ $course->id }}" class="programs__item" style="background-image: url(storage/pics/{{ $course->preview }}); background-size:cover; background-repeat: no-repeat">
