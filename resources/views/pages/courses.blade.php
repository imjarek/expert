        ...
        <div class="card flex-md-row mb-4 box-shadow h-md-400">
            <div class="card-body d-flex flex-column align-items-start">
                ...
                <p class="card-text mb-auto">Структура курса:
                    1 день.
                    1.  Анатомо-физиологические особенности детей 7-10 лет.
                    2. Особенности развития физических качеств детей 7-10 лет.
                    3. Структура и содержание занятий по детском фитнесу.
                    4. Методика проведения занятий по базовой и фитбол-аэробике с детьми 7-10 лет.
                    2 день.
                    1. Фитнес-йога для детей 7-10 лет.
                </p>
                <a href="/pages/child-7-10-fitness">Узнать больше</a>
            </div>
            <img class="card-img-right flex-auto d-none d-md-block" data-src="" alt="" style="width: 200px; height: 250px;" src="/images/child-7-10-fitness.jpg" data-holder-rendered="true">
        </div>
    </div>
    <div class="col-md-6">
        <div class="card flex-md-row mb-4 box-shadow h-md-400">
